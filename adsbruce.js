...
var API_URL = "http://api.adsb.lol/v2/point/51.4706/-0.4619/35";
...
function radarPoint(plane) {
  var distance = distanceKm(AREA_LAT, AREA_LON, plane.lat, plane.lon);
  var bearing = bearingDegrees(AREA_LAT, AREA_LON, plane.lat, plane.lon);
